        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                  <h1>Registro de usuarios <small class="tittles-pages-logo">TIENDA DE REPUESTOS N-ESTRADA</small></h1>
                </div>
                <div class="col-xs-12 col-sm-6 text-center">
                   <br><br><br>
                    ...
                    <br>
                    <img src="assets/img/logoT.png" alt="electrodomesticos" class="img-responsive">
                </div>
