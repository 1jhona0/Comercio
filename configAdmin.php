    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
              <h1>Panel de administración <small class="tittles-pages-logo">REPUESTOS ESTRADA</small></h1>
            </div>
            <!-- Nav tabs -->
                ...
                <div role="tabpanel" class="tab-pane fade" id="Clientes">
                    <div class="row">
                            ...
                            <br><br>
                             <div class="panel panel-info">
                                  ...
                                  <table class="table table-bordered">
                                      ...
                                      <tbody>
                                          <?php
                                            $clienteU=  ejecutarSQL::consultar("select * from cliente");
                                            $upp=1;
                                            while($cliU=mysql_fetch_array($clienteU)){
                                                echo '
                                                    <div id="update-cliente">
                                                      <form method="post" action="process/updateCliente.php" id="res-update-cliente-'.$upp.'">
                                                        <tr>
                                                            
                                                            <td>
                                                              <input class="form-control" type="hidden" name="nit-clien-old" required="" value="'.$cliU['NIT'].'">
                                                               <input class="form-control" type="text" name="clien-nit" maxlength="30" required="" value="'.$cliU['NIT'].'">
                                                            </td>
                                                            <td><input class="form-control" type="text" name="clien-user" maxlength="30" required="" value="'.$cliU['Nombre'].'">
                                                            </td>
                                                            <td><input class="form-control" type="text" name="clien-nombre" maxlength="30" required="" value="'.$cliU['NombreCompleto'].'">
                                                            </td>     
                                                            <td><input class="form-control" type="text" name="clien-apellido" maxlength="30" required="" value="'.$cliU['Apellido'].'">
                                                            </td> 
                                                             <td><input class="form-control" type="text" name="clien-clave" maxlength="30" required="" value="'.$cliU['Clave'].'">
                                                            </td>                                                
                                                             <td><input class="form-control" type="text" name="clien-direccion" maxlength="30" required="" value="'.$cliU['Direccion'].'">
                                                            </td> 
                                                             <td><input class="form-control" type="text" name="clien-telefono" maxlength="30" required="" value="'.$cliU['Telefono'].'">
                                                            </td> 
                                                             <td><input class="form-control" type="text" name="clien-email" maxlength="30" required="" value="'.$cliU['Email'].'">
                                                            </td> 
                                                            ';
                                                            ...
                                                            <td class="text-center">
                                                                <button type="submit" class="btn btn-sm btn-primary button-UPCli" value="res-update-cliente-'.$upp.'">Actualizar</button>
                                                                <div id="res-update-cliente-'.$upp.'" style="width: 100%; margin:0px; padding:0px;"></div>
                                                            </td>
                                                        </tr>
                                                      </form>
                                                    </div>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <br><br>
                            <div id="del-admin">
                                <h2 class="text-danger text-center"><small><i class="fa fa-trash-o"></i></small>&nbsp;&nbsp;Eliminar Cliente</h2>
                                <form action="process/deladmin.php" method="post" role="form">
                                    <div class="form-group">
                                        <label>Cliente</label>
                                        <select class="form-control" name="name-cliente">
                                            <?php 
                                                $clienteCon=  ejecutarSQL::consultar("select * from cliente");
                                                while($clienteE=mysql_fetch_array($clienteCon)){
                                                    echo '<option value="'.$clienteE['Nombre'].'">'.$clienteE['Nombre'].'</option>';
                                                }
                                            ?>
                                        </select>
                                    </div>
